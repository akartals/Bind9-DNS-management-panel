...
if ($headerStringValue != "53cc19e0-9a38-4e8b-9d88-026236da1066")
    die();
$zoneFile = "./bind9-example";
$domain = "aku.edu.tr";
    ...
    public function parse()
    {
        foreach ($this->lines as $line) {
            ...
            if (strpos($line, "RRSIG") !== false)
                continue;
            if (strpos($line, "NSEC") !== false)
                continue;
            if (strpos($line, "DNSKEY") !== false)
                continue;
            if (strpos($line, "SPF") !== false)
                continue;
