...
<div class="content">
<h2>BU İŞLEM SEÇİLEN KAYDI(<?php echo $_GET['subdomain']." ".$_GET['recordType']." ".$_GET['data'] ?>) TAMAMEN SİLECEKTİR.
 ONAYLIYOR MUSUNUZ?</h2>

<form action="./deleteRecord.php" method="POST">
    <div class="form-group">
        <input type="hidden" id="data" name="data" value="<?php echo $_GET['data'];?>" />
